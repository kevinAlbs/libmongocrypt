...
#undef TF
    ...
    // When QE has an encrypted payload, `encryptionInformation` is added to the final command.

    // TODO: Test $lookup with QE from encryptedFieldsMap.

    // TODO: Test $lookup with QE from from cache.
